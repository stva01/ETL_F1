    ...
    create  table
      "f1_analytics"."main_marts"."dim_season__dbt_tmp"
...
driver_champion as (
    ...
    from "f1_analytics"."main_intermediate"."int_standings_driver_eoy" ds
...
constructor_champion as (
    ...
    from "f1_analytics"."main_intermediate"."int_standings_constructor_eoy" cs
