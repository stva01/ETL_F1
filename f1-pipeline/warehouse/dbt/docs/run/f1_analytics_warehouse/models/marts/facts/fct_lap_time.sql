    ...
    create temporary table
      "fct_lap_time__dbt_tmp_485ceb6e_b81e_4ef6_83a5_7b9106ab28ee"
...
where rn = 1
  ...
  ;
            ...
            delete from "f1_analytics"."main_marts"."fct_lap_time" as DBT_INCREMENTAL_TARGET
            using "fct_lap_time__dbt_tmp_485ceb6e_b81e_4ef6_83a5_7b9106ab28ee"
            where (
                
                    "fct_lap_time__dbt_tmp_485ceb6e_b81e_4ef6_83a5_7b9106ab28ee".race_id = DBT_INCREMENTAL_TARGET.race_id
                    and 
                
                    "fct_lap_time__dbt_tmp_485ceb6e_b81e_4ef6_83a5_7b9106ab28ee".driver_key = DBT_INCREMENTAL_TARGET.driver_key
                    and 
                
                    "fct_lap_time__dbt_tmp_485ceb6e_b81e_4ef6_83a5_7b9106ab28ee".lap_number = DBT_INCREMENTAL_TARGET.lap_number
    ...
    insert into "f1_analytics"."main_marts"."fct_lap_time" ("race_id", "driver_key", "season_year", "race_key", "lap_number", "position_on_lap", "lap_time_ms", "sector_1_ms", "sector_2_ms", "sector_3_ms", "is_pit_out_lap", "source_system", "dw_inserted_at")
    (
        select "race_id", "driver_key", "season_year", "race_key", "lap_number", "position_on_lap", "lap_time_ms", "sector_1_ms", "sector_2_ms", "sector_3_ms", "is_pit_out_lap", "source_system", "dw_inserted_at"
        from "fct_lap_time__dbt_tmp_485ceb6e_b81e_4ef6_83a5_7b9106ab28ee"
    )
